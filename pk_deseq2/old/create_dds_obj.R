...
conditions = c(paste0('Treatment', 1:4), paste0('Control', 1:4))
conditions
...
samples = data.frame(snames, condition = factor(c(rep('Treatment', 4),
                                                rep('Control',4))))
print(samples)
...
saveRDS(dds, file = '/Users/hhuang/Desktop/pk/pk_deseq2/dds_object')
